...
function getUserStatus(age) {
  ...
  if (age >= 18 && age < 65) return "Дорослий";
...
function memoizedArea() {
  ...
  return function (side) {
    ...
    if (prevSide === side) {
      ...
      prevSide = side; // Зберігаємо сторону квадрата для майбутнього порівняння
      prevResult = result; // Зберігаємо результат для майбутнього використання
...
// Створюємо змінну incrementAndDouble якій присвоємо результат виконання функції compose з аргументами increment та double
